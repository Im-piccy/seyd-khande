...
class Controller
{
    public:
        ...
        void execute_user_ask_to_use_hero_ability_if_possible(int selected_enemy_index, int selected_ally_index, Argument_Skills_Functions parameters, int hero_index_in_array, ABILITIES which_ability, int user_turn); //it gets user request to atteck and does the logic (considering energy cost)
        ...
        void Fill_Struct_For_Virtual_Functions(int user_turn, int selected_enemy_index, int selected_ally_index, Argument_Skills_Functions parameters);
